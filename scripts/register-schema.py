#!/usr/bin/env python3
"""Register DatasetEvent Avro schema with Confluent Schema Registry."""
import json
import os
import sys
...
SCHEMA_FILE = os.environ.get("SCHEMA_FILE", "../kafka/schemas/no.fdk.dataset.DatasetEvent.avsc")
SUBJECT = os.environ.get("SCHEMA_SUBJECT", "dataset-events-value")
